...
const template = [
  {
    ...
    prompt: 'Give the most asked java interview questions which cover everything',
  },
  {
    title: 'Optimal code',
    prompt: 'Generate optimal code to find the GCD and HCF along with proper explaination',
  },
  {
